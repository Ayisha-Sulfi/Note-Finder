...
if (isset($_GET['delete_id'])) {
    ...
    $delete_query = "DELETE FROM faculties WHERE id = '$delete_id'";
    ...
    <div class="admin-wrapper">
        ...
        <div class="main-content">
            <div class="dashboard-header">
                <div>
                    <h1 class="fw-bold">Faculty List</h1>
                    <p class="text-muted">Manage faculty accounts</p>
                </div>
                <div>
                    <a href="add_faculty.php" class="btn btn-primary">
                        <i class="ph-bold ph-plus me-2"></i>Add New Faculty
                    </a>
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="view_faculties.php?delete_id=<?php echo $row['id']; ?>" 
